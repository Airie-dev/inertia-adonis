...
export type OptionalProp<T extends UnPackedPageProps> = {
  ...
  once(options?: OncePropOptions): OnceProp<OptionalProp<T>>
}
...
export type DeferProp<T extends UnPackedPageProps> = {
  ...
  /** Creates a once prop version that is cached by the client */
  once(options?: OncePropOptions): OnceProp<DeferProp<T>>
...
export type OncePropOptions = {
  ...
  as?: string
  /** Expiration time for this once prop (duration string ['1h', '5m'], Date, or seconds as number) */
